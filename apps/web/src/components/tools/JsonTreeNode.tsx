...
export function JsonTreeNode({ label, value, isLast = true }: { label?: string; value: unknown; isLast?: boolean }) {
  ...
  return (
    <div className="font-mono text-sm ml-4">
      <div className="flex items-center -ml-5">
        ...
        {(!open || isEmpty) && <span className="text-gray-600 dark:text-gray-400">{isArray ? ']' : '}'}{!isLast && ','}</span>}
      </div>
